...
namespace TV.KeycloakSample
{
    ...
    public class PersonAccount : ICSSoft.STORMNET.DataObject
    {
        ...
        private TV.KeycloakSample.SocialNetwork fSocialNetwork;
        ...
        [PropertyStorage(new string[] {
                "SocialNetwork"})]
        [NotNull()]
        public virtual TV.KeycloakSample.SocialNetwork SocialNetwork
        {
            get
            {
                ...
                TV.KeycloakSample.SocialNetwork result = this.fSocialNetwork;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку TV.KeycloakSample.Person.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View PersonAccountE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("PersonAccountE", typeof(TV.KeycloakSample.PersonAccount));
                }
            }
        }
    }
    ...
    public class DetailArrayOfPersonAccount : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (TV.KeycloakSample.DetailArrayOfPersonAccount members)

        // *** End programmer edit section *** (TV.KeycloakSample.DetailArrayOfPersonAccount members)
        ...
        /// </summary>
        public DetailArrayOfPersonAccount(TV.KeycloakSample.Person fPerson) : 
                base(typeof(PersonAccount), ((ICSSoft.STORMNET.DataObject)(fPerson)))
        {
        }
        
        public TV.KeycloakSample.PersonAccount this[int index]
        {
            get
            {
                return ((TV.KeycloakSample.PersonAccount)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(TV.KeycloakSample.PersonAccount dataobject)
        {
